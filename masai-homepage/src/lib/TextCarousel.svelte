    ...
    const messages = [
        {
            ...
            image: "https://www.masaischool.com/images/new-homepage/company-logo1.svg",
        },
        {
            message:
                "I developed Communication Skills, People Skills, Mindset, active patience, JAVA, DSA, JavaScript, CSS, and HTML.",
            name: "Puja Kumari",
            image: "https://www.masaischool.com/images/new-homepage/company-logo2.svg",
        },
        {
            message:
            ...
            image: "https://www.masaischool.com/images/new-homepage/company-logo3.svg",
        },
        {
            message:
                "I learnt a lot from Masai i.e discipline, time management and professionalism.",
            name: "Harshit Tripathi",
            image: "https://www.masaischool.com/images/new-homepage/company-logo4.svg",
        },
    ];
...
<div
    class="m-auto top-0 left-0 h-[170px] p-2 flex justify-between text-left flex-col rounded-xl box-shadow"
>
    <div>
        <img
    ...
    <p>{messages[currentIndex].name}</p>
    <div>
        <img src={messages[currentIndex].image} alt="message-logo" />
    </div>
</div>
