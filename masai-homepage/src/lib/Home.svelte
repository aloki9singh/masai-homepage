...
<div>
  <div
    class="flex p-5 py-10 md:text-left text-center justify-between items-center relative md:flex-row flex-col md:text-auto xl:w-[80%] m-auto"
  >
